      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-[#ECF0F1]/90 max-w-3xl mx-auto font-body">
            Your cosmic journey is protected. Learn how we safeguard your
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 text-[#ECF0F1]/90 font-body leading-relaxed">
              <p>
                At CosmicQuizHub, we collect information to provide you with
                personalized spiritual insights and premium quiz experiences:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>Personal Information:</strong> Email address, name (if
                  provided), and birth date for astrological calculations
                </li>
                <li>
                  <strong>Quiz Responses:</strong> Your answers to astrology,
                  numerology, tarot, and compatibility quizzes
                </li>
                <li>
                  <strong>Usage Data:</strong> How you interact with our
                  quizzes, time spent, and preferences
                </li>
                <li>
                  <strong>Device Information:</strong> Browser type, IP address,
                  and device identifiers for security and optimization
                </li>
                <li>
                  <strong>Cookies:</strong> To remember your preferences and
          ...
          >
            ...
            <div className="space-y-4 text-[#ECF0F1]/90 font-body leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Generate personalized astrology, numerology, and tarot
                  readings
                </li>
                <li>
                  Provide accurate compatibility assessments and love insights
                </li>
                <li>
                  Send you relevant spiritual content and premium quiz
                  recommendations
                </li>
                <li>
                  Improve our quiz algorithms and spiritual guidance accuracy
                </li>
                <li>
                  Communicate about your quiz results and premium offerings
                </li>
                <li>
          ...
          >
            ...
            <div className="space-y-4 text-[#ECF0F1]/90 font-body leading-relaxed">
              <p>
                Your spiritual journey is sacred. We protect your information
                with cosmic-level security:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  <strong>No Sale of Personal Data:</strong> We never sell your
                  personal information to third parties
                </li>
                <li>
                  <strong>Affiliate Partners:</strong> We may share aggregated,
                  non-personal data with our spiritual content partners
                </li>
                <li>
                  <strong>Service Providers:</strong> Trusted partners who help
                  deliver our quiz platform (email services, analytics)
                </li>
                <li>
                  <strong>Legal Requirements:</strong> Only when required by law
                ...
                <li>
                  <strong>Access Controls:</strong> Strict limits on who can
          ...
          >
            ...
            <div className="space-y-4 text-[#ECF0F1]/90 font-body leading-relaxed">
              ...
              <div className="mt-6 p-4 bg-[#8E44AD]/20 rounded-lg border border-[#8E44AD]/30">
                <p className="text-sm">
                  <strong>Contact Us:</strong> For any privacy-related requests,
                  email us at{' '}
                  <a
            ...
            <div className="space-y-4 text-[#ECF0F1]/90 font-body leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  ...
                  functionality and quiz completion
                </li>
                <li>
                  <strong>Analytics Cookies:</strong> Help us understand how you
                  use our quizzes to improve them
                </li>
                <li>
                ...
                <li>
                  <strong>Marketing Cookies:</strong> Show you relevant
                  spiritual content and quiz recommendations
                </li>
              </ul>
          ...
          >
            ...
            <div className="space-y-4 text-[#ECF0F1]/90 font-body leading-relaxed">
              <p>
                As our cosmic platform evolves, we may update this Privacy
                Policy. We'll notify you of significant changes through:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <p>
                Continued use of CosmicQuizHub after policy updates constitutes
