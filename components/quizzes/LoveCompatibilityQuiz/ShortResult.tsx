...
import { Heart, Star, Sparkles, CreditCard } from "lucide-react"
...
const ShortResult: React.FC<ShortResultProps> = ({
  ...
  const handlePayment = async () => {
    ...
    const paymentData = {
      ...
      currency: "usd",
      description: `${quizData.title} - Full Result`,
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
          {userData.crushName ? `You and ${userData.crushName}` : "You and your crush"} score
        </h1>
        ...
        <p className="text-xl text-white/90 mb-8">in cosmic compatibility. The spark is real! ✨</p>

        <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl p-6 mb-8 border border-purple-400/30">
          <h3 className="text-xl font-bold text-white mb-3">Want Your Complete Love Analysis?</h3>
          <p className="text-white/80 mb-4">
            Unlock your full compatibility breakdown, relationship insights, and personalized guidance for just $
            {quizData.price}
          </p>

          <div className="grid md:grid-cols-3 gap-4 mb-6 text-sm">
            <div className="bg-white/10 rounded-lg p-3">
              <div className="text-green-400 font-semibold">✓ Detailed Breakdown</div>
              <div className="text-white/70">All 6 compatibility areas</div>
            </div>
            <div className="bg-white/10 rounded-lg p-3">
              <div className="text-green-400 font-semibold">✓ Growth Insights</div>
              <div className="text-white/70">Relationship guidance</div>
            </div>
            <div className="bg-white/10 rounded-lg p-3">
              <div className="text-green-400 font-semibold">✓ Future Potential</div>
